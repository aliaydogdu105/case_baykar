...
const ProductCards = () => {
  return (
    <div className=" flex flex-col justify-center items-center sm:flex-row w-full h-[1528px] sm:h-[527px] sm:w-[1358px] bg-[url('../../../../public/bgProductsMobile.png')] sm:bg-[url('../../../../public/bgProducts.png')] bg-contain">
      {/* cards */}
